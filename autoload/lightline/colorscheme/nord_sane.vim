" =============================================================================
" Filename: autoload/lightline/colorscheme/colorscheme/nord_sane.vim
" Author: arcticicestudio, Ben Fowler
" License: MIT
" =============================================================================
...
if exists('g:lightline')
  ...
  let s:p.normal.right = [ [ s:nord1, s:nord8 ], [ s:nord5, s:nord1 ] ]
  let s:p.normal.warning = [ [ s:nord1, s:nord13 ] ]
  let s:p.normal.error = [ [ s:nord1, s:nord11 ] ]

  let s:p.inactive.left =  [ [ s:nord5, s:nord1 ], [ s:nord5, s:nord3 ] ]
  let s:p.inactive.middle = [ [ s:nord5, s:nord2 ] ]
  let s:p.inactive.right = [ [ s:nord5, s:nord2 ], [ s:nord5, s:nord1 ] ]

  let s:p.insert.left = [ [ s:nord1, s:nord14 ], [ s:nord5, s:nord1 ] ]
  let s:p.insert.right = [ [ s:nord1, s:nord14 ], [ s:nord5, s:nord1 ] ]
  let s:p.replace.left = [ [ s:nord1, s:nord12 ], [ s:nord5, s:nord1 ] ]
  let s:p.replace.right = [ [ s:nord1, s:nord12 ], [ s:nord5, s:nord1 ] ]
  let s:p.visual.left = [ [ s:nord1, s:nord13 ], [ s:nord5, s:nord1 ] ]
  let s:p.visual.right = [ [ s:nord1, s:nord13 ], [ s:nord5, s:nord1 ] ]
  ...
  let g:lightline#colorscheme#nord_sane#palette = lightline#colorscheme#flatten(s:p)
endif
